...
#Custom
# Project Specific
export TGDSPROJECTNAME = aquariumgl
...
$(EXECUTABLE_FNAME)	:	compile
	...
	$(NDSTOOL)	-c 	${@:.nds=.srl} -g "TGDS" "NN" "NDS.TinyFB" -b	icon.bmp "ToolchainGenericDS SDK;$(TGDSPROJECTNAME) TWL Binary;" -7 $(CURDIR)/arm7/arm7_twl.bin -e7  0x03800000 -9 $(CURDIR)/arm9/arm9_twl.bin -e9  0x02000000
	-mv ${@:.nds=.srl}	/E
